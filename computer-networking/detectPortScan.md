...
If a remote host frequently scans numerous ports of your host, it looks like a port scanner.
...
def detect_portscan(packet):
    ...
    # Remember scanned port and time in unix format TODO:
