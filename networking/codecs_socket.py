# codecs_socket.py
# python3 standard library by example
...
if __name__ == '__main__':
    ...
    t.setDaemon(True) # Don't hand on exit
    t.start()
    ...
    incoming = codecs.getreader('utf-8')(PassThrough(read_file))  #TODO
